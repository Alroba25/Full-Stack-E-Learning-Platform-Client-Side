      ...
      <main className="max-w-4xl mx-auto px-6 py-24 relative z-10">
        ...
        <header className="mb-20">
          ...
          <p className="text-white/50 text-xl leading-relaxed max-w-2xl">
            ...
            accessing Darsify, you agree to be bound by these terms.
          </p>
        </header>
        ...
        <div className="space-y-16">
          <section className="relative group">
            ...
            <div className="prose prose-invert max-w-none text-white/60 leading-loose">
              <p>When using Darsify, you agree to:</p>
              <ul className="grid grid-cols-1 gap-4 mt-6 list-none p-0">
                {[
                  ...
                  <li
                    key={i}
                    className="flex items-center gap-3 bg-white/5 border border-white/5 p-4 rounded-xl hover:border-white/10 transition-colors"
                  >
                    <CheckCircle2
                      size={16}
          ...
          <section className="relative group">
            ...
            <div className="p-8 rounded-[2rem] bg-white/5 border border-white/10 backdrop-blur-sm">
              <p className="text-white/60 leading-loose">
                You may not post or share any content that is discriminatory,
                hateful, violent, or infringing upon others' rights. We reserve
                the right to remove any content and terminate accounts that
                violate these guidelines without prior notice.
              </p>
            </div>
          </section>
          ...
          <section className="relative group">
            ...
            <div className="prose prose-invert max-w-none text-white/60 leading-loose">
              <p>
                Any disputes arising from these terms will be settled through
                arbitration in accordance with local laws. We encourage users to
                contact our support team first to resolve any issues amicably.
              </p>
            </div>
          </section>
        </div>
