      ...
      <main className="flex-1 flex flex-col items-center justify-center p-8 z-10 text-center">
        <div className="relative mb-8 group">
          ...
          <div className="w-32 h-32 bg-white/5 border border-white/10 rounded-full flex items-center justify-center backdrop-blur-xl relative">
            <Compass size={64} className="text-[#4facfe] animate-[spin_10s_linear_infinite]" />
          </div>
        </div>
        ...
        <Link
          href="/"
          className="group flex items-center gap-2 bg-linear-to-r from-[#4facfe] to-[#00f2fe] text-black font-extrabold px-8 py-4 rounded-xl hover:shadow-[0_0_30px_rgba(79,172,254,0.5)] transition-all duration-300 transform hover:-translate-y-1"
        >
          <Home size={20} />
