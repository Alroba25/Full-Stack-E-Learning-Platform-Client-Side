        ...
        <div className="max-w-[1200px] mx-auto px-8 lg:grid lg:grid-cols-[1fr_350px] gap-12">
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-4 text-sm">
              ...
              <span className="text-[#c0c4fc] underline">(2,450 ratings)</span>
          ...
          <div className="space-y-6">
            ...
            <div className="prose prose-invert max-w-none text-[#d1d7dc] space-y-4 text-[0.95rem] leading-relaxed">
              <p>
                ...
                {course?.title}. We have carefully structured the curriculum to
                take you from a complete beginner to a professional level.
              </p>
              <p>
                Whether you are looking to advance your current career or start
                a new path in tech, this course provides the practical skills
                and theoretical knowledge you need to succeed in the modern
                market.
              </p>
